...
public class Fields : BaseTests
{
    ...
    public void CheckBoxFieldConversions()
    {
        ...
        Extend.Fields.CheckBoxField field = value;
    ...
    public void CheckBoxFieldEquals() {
        var field1 = new Extend.Fields.CheckBoxField {
            Value = true
        };
        var field2 = new Extend.Fields.CheckBoxField {
            Value = true
        };
    ...
    public void ColorFieldConversions()
    {
        ...
        Extend.Fields.ColorField field = inStr;
    ...
    {
        var field1 = new Extend.Fields.ColorField
        {
            Value = "#007eaa"
        };
        var field2 = new Extend.Fields.ColorField
        {
            Value = "#007eaa"
        };
    ...
    public void DateFieldConversions() {
        ...
        Extend.Fields.DateField field = now;
        Assert.Equal(now, field.Value);
    }

    [Fact]
    public void DateFieldEquals() {
        var field1 = new Extend.Fields.DateField {
            Value = new DateTime(2018, 1, 1)
        };
        var field2 = new Extend.Fields.DateField {
            Value = new DateTime(2018, 1, 1)
        };
    ...
    public void HtmlFieldConversions() {
        ...
        Extend.Fields.HtmlField field = str;
    ...
    public void HtmlFieldEquals() {
        var field1 = new Extend.Fields.HtmlField {
            Value = "Sollicitudin Justo Tristique"
        };
        var field2 = new Extend.Fields.HtmlField {
            Value = "Sollicitudin Justo Tristique"
        };
    ...
    public void HtmlFieldTitle() {
        Extend.Fields.HtmlField field = "<p>Html value</p>";
    ...
    public void HtmlFieldTitleMaxLength() {
        ...
        Extend.Fields.HtmlField field = sb.ToString();
    ...
    public void ImageFieldConversions() {
        ...
        Extend.Fields.ImageField field = media;
    ...
    public async Task ImageFieldInitMissing() {
        using (var api = CreateApi()) {
            var field = new Extend.Fields.ImageField {
                Id = Guid.NewGuid()
            };
    ...
    public void ImageFieldEquals() {
        var field1 = new Extend.Fields.ImageField {
            Id = Guid.NewGuid()
        };
        var field2 = new Extend.Fields.ImageField {
            Id = field1.Id
        };
    ...
    public void DocumentFieldConversions() {
        ...
        Extend.Fields.DocumentField field = media;
        Assert.Equal(media.Id, field.Id.Value);
    }
    ...
    public async Task DocumentFieldInitMissing() {
        using (var api = CreateApi()) {
            var field = new Extend.Fields.DocumentField {
                Id = Guid.NewGuid()
            };
    ...
    public void DocumentFieldEquals() {
        var field1 = new Extend.Fields.DocumentField {
            Id = Guid.NewGuid()
        };
        var field2 = new Extend.Fields.DocumentField {
            Id = field1.Id
        };
    ...
    public void VideoFieldConversions() {
        ...
        Extend.Fields.VideoField field = media;
        Assert.Equal(media.Id, field.Id.Value);
    }
    ...
    public async Task VideoFieldInitMissing() {
        using (var api = CreateApi()) {
            var field = new Extend.Fields.VideoField {
                Id = Guid.NewGuid()
            };
    ...
    public void VideoFieldEquals() {
        var field1 = new Extend.Fields.VideoField {
            Id = Guid.NewGuid()
        };
        var field2 = new Extend.Fields.VideoField {
            Id = field1.Id
        };
    ...
    public void AudioFieldConversions()
    {
        ...
        Extend.Fields.AudioField field = media;
        Assert.Equal(media.Id, field.Id.Value);
    }
    ...
    public async Task AudioFieldInitMissing()
    {
        using (var api = CreateApi())
        {
            var field = new Extend.Fields.AudioField
            {
                Id = Guid.NewGuid()
            };
    ...
    {
        var field1 = new Extend.Fields.AudioField
        {
            Id = Guid.NewGuid()
        };
        var field2 = new Extend.Fields.AudioField
        {
            Id = field1.Id
        };
    ...
    public void MediaFieldConversions() {
        ...
        Extend.Fields.MediaField field = media;
        Assert.Equal(media.Id, field.Id.Value);
    }
    ...
    public async Task MediaFieldInitMissing() {
        using (var api = CreateApi()) {
            var field = new Extend.Fields.MediaField {
                Id = Guid.NewGuid()
            };
    ...
    public void MediaFieldEquals() {
        var field1 = new Extend.Fields.MediaField {
            Id = Guid.NewGuid()
        };
        var field2 = new Extend.Fields.MediaField {
            Id = field1.Id
        };
    ...
    public void ImageFieldConversionsNullImage() {
        ...
        Extend.Fields.ImageField field = id;
    ...
    public void DocumentFieldConversionsNullDocument() {
        ...
        Extend.Fields.DocumentField field = id;
        Assert.Equal(id, field.Id.Value);
    ...
    public void VideoFieldConversionsNullVideo() {
        ...
        Extend.Fields.VideoField field = id;
        Assert.Equal(id, field.Id.Value);
    ...
    public void AudioFieldConversionsNullAudio()
    {
        ...
        Extend.Fields.AudioField field = id;
        Assert.Equal(id, field.Id.Value);
    ...
    public void MediaFieldConversionsNullMedia() {
        ...
        Extend.Fields.MediaField field = id;
        Assert.Equal(id, field.Id.Value);
    ...
    public void MarkdownFieldConversions() {
        ...
        Extend.Fields.MarkdownField field = md;
    ...
    public void MarkdownFieldEquals() {
        var field1 = new Extend.Fields.MarkdownField {
            Value = "Sollicitudin Justo Tristique"
        };
        var field2 = new Extend.Fields.MarkdownField {
            Value = "Sollicitudin Justo Tristique"
        };
    ...
    public void NumberFieldConversions() {
        ...
        Extend.Fields.NumberField field = number;
    ...
    public void NumberFieldEquals() {
        var field1 = new Extend.Fields.NumberField {
            Value = 23
        };
        var field2 = new Extend.Fields.NumberField {
            Value = 23
        };
    ...
    public void PageFieldEquals() {
        var field1 = new Extend.Fields.PageField {
            Id = Guid.NewGuid()
        };
        var field2 = new Extend.Fields.PageField {
            Id = field1.Id
        };
    ...
    public void PostFieldEquals() {
        var field1 = new Extend.Fields.PostField {
            Id = Guid.NewGuid()
        };
        var field2 = new Extend.Fields.PostField {
            Id = field1.Id
        };
    ...
    public void SelectFieldEquals() {
        var field1 = new Extend.Fields.SelectField<MyEnum> {
            Value = MyEnum.Value1
        };
        var field2 = new Extend.Fields.SelectField<MyEnum> {
            Value = MyEnum.Value1
        };
    ...
    public void StringFieldConversions() {
        ...
        Extend.Fields.StringField field = inStr;
        Assert.Equal(inStr, field.Value);
    ...
    public void StringFieldEquals() {
        var field1 = new Extend.Fields.StringField {
            Value = "Sollicitudin Justo Tristique"
        };
        var field2 = new Extend.Fields.StringField {
            Value = "Sollicitudin Justo Tristique"
        };
    ...
    public void TextFieldConversions() {
        ...
        Extend.Fields.TextField field = inStr;
        Assert.Equal(inStr, field.Value);
    ...
    public void TextFieldEquals() {
        var field1 = new Extend.Fields.TextField {
            Value = "Sollicitudin Justo Tristique"
        };
        var field2 = new Extend.Fields.TextField {
            Value = "Sollicitudin Justo Tristique"
        };
    ...
    public void GetFieldTitleNull() {
        var field = new Extend.Fields.TextField();
    ...
    public void GetFieldTitle() {
        Extend.Fields.TextField field = "String value";
    ...
    public void GetFieldTitleMaxLength() {
        ...
        Extend.Fields.TextField field = sb.ToString();
    ...
    public void ReadonlyFieldConversions()
    {
        ...
        Extend.Fields.ReadonlyField field = value;
        Assert.Equal(value, field.Value);
